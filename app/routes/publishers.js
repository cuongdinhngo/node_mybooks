...
router.post('/add', [Image.upload_image, Image.resize_image], publisherController.add_publisher);

router.get('/edit/:_id', publisherController.get_form_edit_publisher);

router.post('/edit/:_id', [Image.upload_image, Image.resize_image], publisherController.edit_publisher);
